# Comentarios
- Este proyecto hace uso de la base h2. Así que la misma debe estar incluída en el classpath.
- Configuración H2: conn = DriverManager.getConnection("jdbc:h2:~/test", "sa", "");
...
3. Correr el script llamado clase_8_script.sql para inicializar la base de datos.
